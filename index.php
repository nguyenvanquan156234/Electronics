...
<body>
	...
	} else if ($tam1 == 'dangnhap') {

		include_once './include/login.php';
	} else if ($tam1 == 'matkhau') {
		include_once './include/quenmatkhau.php';
	} else if ($tam1 == 'danhgia') {
		include_once './include/danhgia.php';
	} else if($tam1=='timkiem'){
		include_once './include/timkiem.php';
	}else if($tam1=='xemdonhang'){
		include_once './include/xemdonhang.php';
	}else if($tam1=='giohang'){
		include_once './include/giohang.php';
	}else if($tam1=='doimatkhau'){
		include_once './include/resetpassword.php';
	}else if($tam1=='traloi'){
		include_once './include/traloibinhluan.php';
	}else {
