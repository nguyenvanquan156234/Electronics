    ...
    if(isset($_POST['dangnhap'])){
        ...
        $matkhau=md5($_POST['matkhau']);
         if($taikhoan=='' || $matkhau=='') {
          ...
          $sql_select_admin = mysqli_query($mysqli,"SELECT * FROM tbl_admin WHERE email='$taikhoan' AND password='$matkhau'");
          $count = mysqli_num_rows($sql_select_admin);
          $row_dangnhap = mysqli_fetch_array($sql_select_admin);
          if($count>0 ){
            $_SESSION['dangnhap'] = $row_dangnhap['admin_name'];
            $_SESSION['id'] = $row_dangnhap['admin_id'];
...
<form class="form " method="POST">
     <div class="form-title"><span>Đăng Nhập</span></div>
      ...
      <div class="input-container">
        <input class="input-mail" name="taikhoan" type="email" placeholder="Enter email">
        <span> </span>
      </div>
      ...
      <div class="input-container">
        <input class="input-pwd" name="matkhau" type="password" placeholder="Enter password">
      </div>
      ...
      <p class="signup-link">
        Không có tài khoản?
        <a href="" class="up">Đăng ký ngay!</a>
      </p>
